...
4. **Update Jira** — run `jirha update <KEY> -c "PR status: ..."` to add a status comment
5. **Transition Jira** — if the PR is merged, offer to transition the issue via `jirha transition <KEY>`
